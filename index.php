...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbаarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#service">Техники</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#masters">Наша работа</a>
          </li>
           <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/admin.php">Админ</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/login.php">Вход</a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="modal fade" id="techniqueModal" tabindex="-1" role="dialog">
  ...
  <!-- СКРИПТ ДЛЯ ВЫВОДА КАРТОЧЕК С ПОДРОБНЫМ ОПИСАНИЕМ -->
  <script>
